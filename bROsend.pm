...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'092C' => ['actor_look_at', 'v C', [qw(head body)]],
		...
		'0889' => ['friend_request', 'a*', [qw(username)]],
		'087C' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
	...
	$self->cryptKeys(1580560024, 807083187, 521959061);
