...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'095A' => ['actor_look_at', 'v C', [qw(head body)]],
		'092F' => ['item_take', 'a4', [qw(ID)]],
		'087A' => ['item_drop', 'v2', [qw(index amount)]],
		'0363' => ['storage_item_add', 'v V', [qw(index amount)]],
		'0932' => ['storage_item_remove', 'v V', [qw(index amount)]],
		...
		'0924' => ['booking_register', 'v8', [qw(level MapID job0 job1 job2 job3 job4 job5)]], # Booking Register
		...
		'092A' => ['friend_request', 'a*', [qw(username)]],
		'0923' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
		'0362' => ['storage_password'],		
	);
	...
	$self->cryptKeys(2120356683, 1570650012, 1611875407);
