...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'0817' => ['actor_look_at', 'v C', [qw(head body)]],
		...
		'0835' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
		'0954' => ['storage_password'],		
	);
	...
	$self->cryptKeys(2090695261, 1724789286, 1620518720);
