...
sub new {
	...
	my %packets = (
		...
		'0866' => ['friend_request', 'a*', [qw(username)]],
		'08A2' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
		'0964' => ['storage_password'],		
	);
	...
	$self->cryptKeys(548752231, 904928424, 735005906);
