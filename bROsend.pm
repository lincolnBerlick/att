...
sub new {
	...
	my %packets = (
		...
		'0967' => ['item_drop', 'v2', [qw(index amount)]],
		...
		'0969' => ['booking_register', 'v8', [qw(level MapID job0 job1 job2 job3 job4 job5)]], # Booking Register
		'088F' => ['item_list_res', 'v V2 a*', [qw(len type action itemInfo)]],
		'086D' => ['map_login', 'a4 a4 a4 V C', [qw(accountID charID sessionID tick sex)]],
		'0953' => ['party_join_request_by_name', 'Z24', [qw(partyName)]],
		'089C' => ['friend_request', 'a*', [qw(username)]],
	...
	$self->cryptKeys(1550521385, 2104187516, 1437412447);
