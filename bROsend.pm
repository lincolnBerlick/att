...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'093B' => ['actor_look_at', 'v C', [qw(head body)]],
		...
		'08A4' => ['friend_request', 'a*', [qw(username)]],
		'094B' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
		'088D' => ['storage_password'],		
	);
	...
	$self->cryptKeys(1706961401, 13967641, 96734588);
